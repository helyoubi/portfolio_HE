...
Avant **toute génération ou modification de code**, lire l'agent d'instruction le plus pertinent dans le dossier [`docs/`](docs/) (index ci-dessous). Si plusieurs agents s'appliquent, lire chacun et combiner. En cas de conflit, ce fichier (`AGENTS.md`) fait foi.
